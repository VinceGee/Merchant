package com.vhg.empire.merchant.search.scanner;
...
import com.vhg.empire.merchant.search.ListResult;
import com.vhg.empire.merchant.search.utilities.ZXingScannerView;
...
public class FullScannerFragment extends Fragment implements MessageDialogFragment.MessageDialogListener,
    ...
    public static FullScannerFragment newInstance() {
        return new FullScannerFragment(firstPageListener);
    }
    public FullScannerFragment(FirstPageFragmentListener listener) {
    ...
    public void handleResult(Result rawResult) {
        ...
        searchIntent.putExtra("keyword",rawResult.getText());
        //call the screen for listing
        startActivity(searchIntent);
        Log.e("Raw Result",rawResult.getText());
