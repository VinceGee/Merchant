package com.vhg.empire.merchant.Account.Settings;
...
public class Preference extends android.preference.Preference {
  ...
  protected void onBindView(View view) {
    ...
    titleView = (TextView) view.findViewById(R.id.title_settings);
    titleView.setText(title);
    titleView.setVisibility(!isEmpty(title) ? VISIBLE : GONE);
    Typeface title_font = Typeface.createFromAsset(getContext().getAssets(), "fonts/Roboto-Regular.ttf");
    titleView.setTypeface(title_font);

    CharSequence summary = getSummary();
    summaryView = (TextView) view.findViewById(R.id.summary_settings);
    summaryView.setText(summary);
    summaryView.setVisibility(!isEmpty(summary) ? VISIBLE : GONE);
    Typeface summary_font = Typeface.createFromAsset(getContext().getAssets(), "fonts/Roboto-Regular.ttf");
    summaryView.setTypeface(summary_font);
