...
import static com.vhg.empire.merchant.search.fab.ViewAnimationUtils.SimpleAnimationListener;
...
public interface RevealAnimator{
    ...
    /**
     * {@link io.codetail.animation.ViewAnimationUtils#createCircularReveal(View, int, int, float, float)} is
