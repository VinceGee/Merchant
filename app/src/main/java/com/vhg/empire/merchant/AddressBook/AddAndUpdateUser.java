 ...
 */
public class AddAndUpdateUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_add_updat);
        ...
        add_save_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (valid_name != null && valid_mob_number != null
                    ...
                    Toast_msg = "Contact added successfully";
            ...
            public void onClick(View v) {
                ...
                if (valid_name != null && valid_mob_number != null
                    ...
                    dbHandler.Update_Contact(new Contact(USER_ID, valid_name,
                            valid_mob_number, valid_email));
                    dbHandler.close();
                    Toast_msg = "Contact Updated successfully";
                    Show_Toast(Toast_msg);
                    Reset_Text();
                } else {
        ...
        update_view_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent view_user = new Intent(AddAndUpdateUser.this,ContactsMain.class);
