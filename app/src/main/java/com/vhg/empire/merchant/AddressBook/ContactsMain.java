package com.vhg.empire.merchant.AddressBook;
...
/**
 * Created by VinceGee on 11/4/2015.
 */
public class ContactsMain extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_update_con_main);
        ...
        add_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent add_user = new Intent(ContactsMain.this, AddAndUpdateUser.class);
    ...
    public void Set_Referash_Data() {
        ...
        db.close();
        cAdapter = new Contact_Adapter(ContactsMain.this, R.layout.listview_row, contact_data);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent update_user = new Intent(activity, AddAndUpdateUser.class);
